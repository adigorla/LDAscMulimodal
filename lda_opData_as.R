...
combMAT <- Matrix::readMM(paste0('./opmultiome_GEXATACas.binarized','.mtx.gz'))*1
head(combMAT)
gene.names = read.delim(paste0('./opmultiome_GEXATACas.quantitative.features','.tsv'),
                        header = TRUE,
                        stringsAsFactors = FALSE)
annots = read.delim(paste0('./opmultiome_GEXATACas.quantitative.annot','.tsv'),
                    header = TRUE,
                    stringsAsFactors = FALSE)
